...
from constant import START_TAG, STOP_TAG
...
class BiLSTM_CRF(nn.Module):
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim, device):
        ...
        # Constraints so that we never transfer into START_TAG or out of STOP_TAG
    ...
    def init_hidden(self):
        # The axes semantics are (num_layers * num_directions, batch_size, hidden_dim)
    ...
    def _forward_alg(self, feats):
        ...
        for feat in feats:
            ...
            for next_tag in range(self.tagset_size):
                # emit_score is same regardless of previous tag
    ...
    def _get_lstm_features(self, sentence):
        ...
        self.hidden = self.init_hidden()
        # reshaping for LSTM => (seq_len, batch_size=1, embedding_dim)
